...
<div class="indexdemo">
    ...
    <div v-else>
        ...
        <!-- alt="跟阿铭学Linux(第三版) by 李世明" class="grid-product__image" -->
        <div>
          <Carousel style="width: 80%;margin: 1% auto;background:#506b9e;" autoplay v-model="value" loop>
            <CarouselItem>
                <div class="demo-carousel">
                  <img height="500px" object-fit="contain" width="100%" src="@/assets/en_1.jpg" >
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                  <img height="500px" width="100%" object-fit="contain" src="@/assets/en_2.jpg" >
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                  <img height="500px" width="100%" object-fit="contain" src="@/assets/en_3.jpg" >
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                  <img height="500px"  width="100%" object-fit="contain" src="@/assets/timg.jpg" >
                </div>
            </CarouselItem>
          </Carousel>
        </div>
...
export default {
  data() {
    return {
      value: 0, flag: false, modal: false, modal_loading: false,
...
.product-grid9 .product-image9 img{width:250px;height:300px}
