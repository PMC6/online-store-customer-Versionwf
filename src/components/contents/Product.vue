              ...
              <div class="product-grid9">
                  <div class="product-image9">
                      ...
                      <a v-else>
                       ...
                       <ul class="social">
                        <li @click="clickEvent(item)"><i class="fa fa-search"></i></li>
                        <li @click="addProduct()"><i class="fa fa-shopping-bag"></i></li>
                        <li @click="addToCart()"><i class="fa fa-shopping-cart"></i></li>
                    </ul>
                  </div>
